...
class LoanController extends Controller
{
    ...
    public function getLoansToCSV(Request $request)
    {
        ...
        $request["allDates"] = ($request["allDates"] == "true" ? true : false);
        $request["professor"] = ($request["professor"] == "true" ? true : false);
        $request["student"] = ($request["student"] == "true" ? true : false);
        $request["allStatus"] = ($request["allStatus"] == "true" ? true : false);
