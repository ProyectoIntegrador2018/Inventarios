...
<html>
    ...
    <body>
        ...
        <br>
        <div>El préstamo que ha solicitado con el identificador <strong>{{$loanID}}</strong> ha sido cancelado dado que el profesor ha declinado la responsabilidad de este.</div>
        <br>
